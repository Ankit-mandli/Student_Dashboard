                        ...
                        <div class="col-md-12 col-sm-12 col-12">
                            <table class="table table-bordered text-white table-responsive">
                                ...
                                if (isset($_POST['submit2'])) {
                                    $S_city = mysqli_real_escape_string($conn, $_POST['city1']);
                                    
                                    $S_age = mysqli_real_escape_string($conn, $_POST['age1']);
                                    if ($S_age <= 18) {
                                        $sql = "select * from students where city = '$S_city' and age<='$S_age'";
                                    }
                                    else{
                                        $sql = "select * from students where city = '$S_city' and age>='$S_age'";
                                    }
                            ...
                            <form action="filter.php" method="post">
                                <label>Choose Location Filter:</label>
                                <select  required name="city1" class="form-select form-group jp-form-input py-lg-2">
                                ...
                                <label>Choose Age Filter:</label>
                                <select class="form-group" required name="age1" id="cars">


                                    <option disabled selected value> -- select an option -- </option>
                                    <option value="18">less than 18</option>
                                    <option value="19">greater than 18</option>

                                </select>
                                <label>Choose Dob Filter:</label>
